...
public class ShapeAttributes extends ForwardingMap<String, String>
    ...
    /**
     * Constructs a new ShapeAttributes object.
     * 
     * @param attributes the attributes from the region represented by the given geometry
    ...
    public static ShapeAttributes emptyIntersection(Geometry geometry) {
        Map<String, String> attributes = Collections.emptyMap();
        return new ShapeAttributes(attributes, geometry, 0.0);
    }
    ...
    /**
     * Gets the geometric shape that was intersected.
     * 
