...
/**
 * The VIIRS Active Fire Upload Ingest method.
 */
@MetaInfServices
public class VIIRSUploadIngestMethod implements UploadIngestMethod {
    private static final Logger log = LoggerFactory.getLogger(VIIRSUploadIngestMethod.class);
    private final Source source;
    private final GeometryBuilder geometryBuilder;
    private static final double ASSUMED_FIRE_AREA_METERS = 0.0;

    public VIIRSUploadIngestMethod(Source source, GeometryBuilder geometryBuilder) {
        this.source = source;
    ...
    private class ResultsCollection extends AbstractCollection<RawData> {
        ...
        public Iterator<RawData> iterator() {
            return new VIIRSResultsIterator(date, fieldNames, data);
        }
