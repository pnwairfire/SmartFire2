...
/**
 * The Simple Data Upload Ingest method (for non-spatial fire data with one record per fire).
 */
@MetaInfServices
public class SimpleDataUploadIngestMethod implements UploadIngestMethod {
    private static final Logger log = LoggerFactory.getLogger(SimpleDataUploadIngestMethod.class);
    ...
    public SimpleDataUploadIngestMethod(Source source, GeometryBuilder geometryBuilder, 
