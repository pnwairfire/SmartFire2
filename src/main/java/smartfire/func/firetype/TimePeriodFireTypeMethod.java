...
/**
 * This fire type method uses a shapefile with an attribute for the wildfire
 * season encoded by months of the year (e.g., 4,5,6).
 */
@MetaInfServices
public class TimePeriodFireTypeMethod implements FireTypeMethod {
    private final GeometryBuilder geometryBuilder;
    private final Source source;
    private final String fireTypeShapeFile;
    private final String wildFireTimeFrameAttributeName;

    public TimePeriodFireTypeMethod(GeometryBuilder geometryBuilder, Source source,
