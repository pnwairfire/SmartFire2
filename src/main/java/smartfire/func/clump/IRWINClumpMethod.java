 ...
 */
@MetaInfServices
public class IRWINClumpMethod implements ClumpMethod {
    private static final Logger log = LoggerFactory.getLogger(IRWINClumpMethod.class);
    private static final double ONE_ACRE_CIRCLE_RADIUS_METERS = 35.890868;
    private final GeometryBuilder geometryBuilder;
    private final Source source;

    public IRWINClumpMethod(GeometryBuilder geometryBuilder, Source source) {
    ...
    public Collection<Clump> clump(Iterable<RawData> rawData) {
        ...
        for(RawData rec : rawData) {
            ...
            // and calculate a circle of that area centered on the IRWIN
