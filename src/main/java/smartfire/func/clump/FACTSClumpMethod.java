...
/**
 * A ClumpMethod designed for FACTS data.
 */
@MetaInfServices
public class FACTSClumpMethod implements ClumpMethod {
    private static final double ONE_ACRE_CIRCLE_RADIUS_METERS = 35.890868;
    private static final Logger log = LoggerFactory.getLogger(FACTSClumpMethod.class);
    private final GeometryBuilder geometryBuilder;
    private final Source source;

    public FACTSClumpMethod(GeometryBuilder geometryBuilder, Source source) {
    ...
    public Collection<Clump> clump(Iterable<RawData> rawData) {
        ...
        for(RawData rec : rawData) {
            ...
            // and calculate a circle of that area centered on the FACTS
