...
/**
 * A ClumpMethod designed for MTBS data.
 */
@MetaInfServices
public class MTBSClumpMethod implements ClumpMethod {
    private static final Logger log = LoggerFactory.getLogger(MTBSClumpMethod.class);
    private final GeometryBuilder geometryBuilder;
    private final Source source;

    public MTBSClumpMethod(GeometryBuilder geometryBuilder, Source source) {
