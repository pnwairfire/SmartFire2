...
/**
 * Factory for constructing AssociationMethods.
 */
public interface AssociationMethodFactory extends MethodFactory {
    /**
     * Constructs a new AssociationMethod implementation object corresponding
     * to the given implementation name.
     * 
     * @param methodName the name of the AssociationMethod
     * @param source the corresponding input Source entity
     * @return a new AssociationMethod instance
     */
    AssociationMethod newAssociationMethod(String methodName, Source source);
}
