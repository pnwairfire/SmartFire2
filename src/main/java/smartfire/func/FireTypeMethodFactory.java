...
/**
 * Factory for constructing FireTypeMethods.
 */
public interface FireTypeMethodFactory extends MethodFactory {
    /**
     * Constructs a new FireTypeMethod implementation object corresponding
     * to the given implementation name.
     *
     * @param methodName the name of the FireTypeMethod
     * @param geometryBuilder
     * @param source the corresponding input Source entity
     * @return a new FireTypeMethod instance
     */
    FireTypeMethod newFireTypeMethod(String methodName, GeometryBuilder geometryBuilder, Source source);
}
