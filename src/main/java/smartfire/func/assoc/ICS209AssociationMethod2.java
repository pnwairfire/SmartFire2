...
/**
 * Another AssociationMethod designed for ICS-209 data.  This one associates based on shape and time overlap 
 * and does not take incident number into account (which can be unreliable).
 */
@MetaInfServices
public class ICS209AssociationMethod2 implements AssociationMethod {
    private static final Logger log = LoggerFactory.getLogger(ICS209AssociationMethod2.class);
    private final int numForwardDays;
    private final int numBackwardDays;
    
    public ICS209AssociationMethod2(
